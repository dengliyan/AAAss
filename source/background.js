...
var md = function callback(item)
      {
        ...
        // xl_plugin.SendBhoLaunchSourceStat(2, item.url);
...
function xmd(_href,_src,_name){
    var href = "http://d.miwifi.com/d2r/?url=" + Base64.encodeURI(_href) + "&src="+encodeURIComponent(_src)+'&name='+encodeURIComponent(_name)
    window.open(href);
}
